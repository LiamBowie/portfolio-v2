...
const bioText = [
    ...
    'is a skilled computer scientist and musician with a passion for solving puzzles and building cool projects. He holds first class honours degrees in both computer science and music education. Currently focusing on front end web development, he aspires to become a full stack engineer and build innovative projects. When he’s not staring at a screen, Liam plays in band pits for local musical theatre productions.',
    'is a skilled computer scientist and musician with a passion for solving puzzles and building cool projects. He holds first class honours degrees in both computer science and music education. Currently focusing on front end web development, he aspires to become a full stack engineer and build innovative projects. When he’s not staring at a screen, Liam plays in band pits for local musical theatre productions. In his free time, Liam enjoys motorcycle riding, and playing Dungeons and Dragons. He is a lifelong learner with a diverse range of interests and a bright future ahead.',
